...
public class ModuleFreqSwitchSynSignalAd extends BaseHandler implements EventHandler {
...
//                writeToProcess(processOutput0, "open_hw_target" + "\n");
                writeToProcess(processOutput0, 0,"open_hw_target "+properties.getProperty("ModuleFreqSwitchSynSignalAd.boxNum0") + "\n");
                writeToProcess(processOutput0, 0,"close_hw_target "+properties.getProperty("ModuleFreqSwitchSynSignalAd.boxNum1") + "\n");
                writeToProcess(processOutput0, 0,"close_hw_target "+properties.getProperty("ModuleFreqSwitchSynSignalAd.boxNum2") + "\n");
                writeToProcess(processOutput0, 0,"close_hw_target "+properties.getProperty("ModuleFreqSwitchSynSignalAd.boxNum3") + "\n");
                Thread.sleep(10000);
                ...
                Thread.sleep(5000);
                writeToProcess(processOutput0, 0,"set_property PROBES.FILE "+properties.getProperty("ModuleFreqSwitchSynSignalAd.probesPath0")+" [get_hw_devices xc7vx690t_0]" + "\n");
                writeToProcess(processOutput0, 0,"set_property FULL_PROBES.FILE "+properties.getProperty("ModuleFreqSwitchSynSignalAd.probesPath0")+" [get_hw_devices xc7vx690t_0]" + "\n");
                writeToProcess(processOutput0, 0,"set_property PROGRAM.FILE "+properties.getProperty("ModuleFreqSwitchSynSignalAd.programPath0")+" [get_hw_devices xc7vx690t_0]" + "\n");
                ...
                writeToProcess(processOutput0,0,"set_property OUTPUT_VALUE 0 [get_hw_probes Inst_freq_change_syn/LD -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                writeToProcess(processOutput0,0,"commit_hw_vio [get_hw_probes {Inst_freq_change_syn/LD} -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                writeToProcess(processOutput0,0,"set_property OUTPUT_VALUE 1 [get_hw_probes Inst_freq_change_syn/LD -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                writeToProcess(processOutput0,0,"commit_hw_vio [get_hw_probes {Inst_freq_change_syn/LD} -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                writeToProcess(processOutput0,0,"set_property TRIGGER_COMPARE_VALUE eq1'bR [get_hw_probes Inst_freq_change_syn/IO_syn_iddr -of_objects [get_hw_ilas -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_ila_freq_change_syn\"}]]"+"\n");
                writeToProcess(processOutput0,0,"set_property CONTROL.TRIGGER_POSITION 100 [get_hw_ilas -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_ila_freq_change_syn\"}]"+"\n");
                writeToProcess(processOutput0,0,"set_property INPUT_VALUE_RADIX UNSIGNED [get_hw_probes Inst_freq_change_syn/CNTVALUEOUT -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                writeToProcess(processOutput0,0,"set_property OUTPUT_VALUE_RADIX UNSIGNED [get_hw_probes Inst_freq_change_syn/CNTVALUEIN -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                
                for(int datadelay=0;datadelay<32;datadelay++){
                    writeToProcess(processOutput0,0,"set_property OUTPUT_VALUE "+datadelay+" [get_hw_probes Inst_freq_change_syn/CNTVALUEIN -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                    writeToProcess(processOutput0,0,"commit_hw_vio [get_hw_probes {Inst_freq_change_syn/CNTVALUEIN} -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                    ...
                    //开始等待触发
                    writeToProcess(processOutput0,0,"run_hw_ila [get_hw_ilas -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_ila_freq_change_syn\"}]"+"\n");
                    ...
                    writeToProcess(processOutput0,0,"wait_on_hw_ila [get_hw_ilas -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_ila_freq_change_syn\"}]"+"\n");
                    writeToProcess(processOutput0,0,"upload_hw_ila_data [get_hw_ilas -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_ila_freq_change_syn\"}]"+"\n");
                    writeToProcess(processOutput0,0, "write_hw_ila_data -csv_file {"+properties.getProperty("ModuleFreqSwitchSynSignalAd.samplePath")
...
//                writeToProcess(processOutput1, "open_hw_target" + "\n");
                writeToProcess(processOutput1, 1,"close_hw_target "+properties.getProperty("ModuleFreqSwitchSynSignalAd.boxNum0") + "\n");
                writeToProcess(processOutput1, 1,"open_hw_target "+properties.getProperty("ModuleFreqSwitchSynSignalAd.boxNum1") + "\n");
                writeToProcess(processOutput1, 1,"close_hw_target "+properties.getProperty("ModuleFreqSwitchSynSignalAd.boxNum2") + "\n");
                writeToProcess(processOutput1, 1,"close_hw_target "+properties.getProperty("ModuleFreqSwitchSynSignalAd.boxNum3") + "\n");
                Thread.sleep(10000);
                ...
                Thread.sleep(5000);
                writeToProcess(processOutput1, 1,"set_property PROBES.FILE "+properties.getProperty("ModuleFreqSwitchSynSignalAd.probesPath1")+" [get_hw_devices xc7vx690t_0]" + "\n");
                writeToProcess(processOutput1, 1,"set_property FULL_PROBES.FILE "+properties.getProperty("ModuleFreqSwitchSynSignalAd.probesPath1")+" [get_hw_devices xc7vx690t_0]" + "\n");
                writeToProcess(processOutput1, 1,"set_property PROGRAM.FILE "+properties.getProperty("ModuleFreqSwitchSynSignalAd.programPath1")+" [get_hw_devices xc7vx690t_0]" + "\n");
                ...
                writeToProcess(processOutput1,1,"set_property OUTPUT_VALUE 0 [get_hw_probes Inst_freq_change_syn/LD -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                writeToProcess(processOutput1,1,"commit_hw_vio [get_hw_probes {Inst_freq_change_syn/LD} -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                writeToProcess(processOutput1,1,"set_property OUTPUT_VALUE 1 [get_hw_probes Inst_freq_change_syn/LD -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                writeToProcess(processOutput1,1,"commit_hw_vio [get_hw_probes {Inst_freq_change_syn/LD} -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                writeToProcess(processOutput1,1,"set_property TRIGGER_COMPARE_VALUE eq1'bR [get_hw_probes Inst_freq_change_syn/IO_syn_iddr -of_objects [get_hw_ilas -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_ila_freq_change_syn\"}]]"+"\n");
                writeToProcess(processOutput1,1,"set_property CONTROL.TRIGGER_POSITION 100 [get_hw_ilas -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_ila_freq_change_syn\"}]"+"\n");
                writeToProcess(processOutput1,1,"set_property INPUT_VALUE_RADIX UNSIGNED [get_hw_probes Inst_freq_change_syn/CNTVALUEOUT -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                writeToProcess(processOutput1,1,"set_property OUTPUT_VALUE_RADIX UNSIGNED [get_hw_probes Inst_freq_change_syn/CNTVALUEIN -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");

                for(int datadelay=0;datadelay<32;datadelay++){
                    writeToProcess(processOutput1,1,"set_property OUTPUT_VALUE "+datadelay+" [get_hw_probes Inst_freq_change_syn/CNTVALUEIN -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                    writeToProcess(processOutput1,1,"commit_hw_vio [get_hw_probes {Inst_freq_change_syn/CNTVALUEIN} -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                    ...
                    //开始等待触发
                    writeToProcess(processOutput1,1,"run_hw_ila [get_hw_ilas -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_ila_freq_change_syn\"}]"+"\n");
                    System.out.println("process1到达检查点二#0，等待同步触发...当前datadelay："+datadelay);
                    countDownLatchs1[datadelay][0].countDown();
                    LockSupport.park();
                    System.out.println("process1通过检查点二#0，被合路板唤起...");

                    writeToProcess(processOutput1,1,"wait_on_hw_ila [get_hw_ilas -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_ila_freq_change_syn\"}]"+"\n");
                    writeToProcess(processOutput1,1,"upload_hw_ila_data [get_hw_ilas -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_ila_freq_change_syn\"}]"+"\n");
                    writeToProcess(processOutput1,1, "write_hw_ila_data -csv_file {"+properties.getProperty("ModuleFreqSwitchSynSignalAd.samplePath")
...
//                writeToProcess(processOutput2, "open_hw_target" + "\n");
                writeToProcess(processOutput2, 2,"close_hw_target "+properties.getProperty("ModuleFreqSwitchSynSignalAd.boxNum0") + "\n");
                writeToProcess(processOutput2, 2,"close_hw_target "+properties.getProperty("ModuleFreqSwitchSynSignalAd.boxNum1") + "\n");
                writeToProcess(processOutput2, 2,"open_hw_target "+properties.getProperty("ModuleFreqSwitchSynSignalAd.boxNum2") + "\n");
                writeToProcess(processOutput2, 2,"close_hw_target "+properties.getProperty("ModuleFreqSwitchSynSignalAd.boxNum3") + "\n");
                Thread.sleep(10000);
                ...
                Thread.sleep(5000);
                writeToProcess(processOutput2, 2,"set_property PROBES.FILE "+properties.getProperty("ModuleFreqSwitchSynSignalAd.probesPath2")+" [get_hw_devices xc7vx690t_0]" + "\n");
                writeToProcess(processOutput2, 2,"set_property FULL_PROBES.FILE "+properties.getProperty("ModuleFreqSwitchSynSignalAd.probesPath2")+" [get_hw_devices xc7vx690t_0]" + "\n");
                writeToProcess(processOutput2, 2,"set_property PROGRAM.FILE "+properties.getProperty("ModuleFreqSwitchSynSignalAd.programPath2")+" [get_hw_devices xc7vx690t_0]" + "\n");
                ...
                writeToProcess(processOutput2,2,"set_property OUTPUT_VALUE 0 [get_hw_probes Inst_freq_change_syn/LD -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                writeToProcess(processOutput2,2,"commit_hw_vio [get_hw_probes {Inst_freq_change_syn/LD} -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                writeToProcess(processOutput2,2,"set_property OUTPUT_VALUE 1 [get_hw_probes Inst_freq_change_syn/LD -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                writeToProcess(processOutput2,2,"commit_hw_vio [get_hw_probes {Inst_freq_change_syn/LD} -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                writeToProcess(processOutput2,2,"set_property TRIGGER_COMPARE_VALUE eq1'bR [get_hw_probes Inst_freq_change_syn/IO_syn_iddr -of_objects [get_hw_ilas -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_ila_freq_change_syn\"}]]"+"\n");
                writeToProcess(processOutput2,2,"set_property CONTROL.TRIGGER_POSITION 100 [get_hw_ilas -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_ila_freq_change_syn\"}]"+"\n");
                writeToProcess(processOutput2,2,"set_property INPUT_VALUE_RADIX UNSIGNED [get_hw_probes Inst_freq_change_syn/CNTVALUEOUT -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                writeToProcess(processOutput2,2,"set_property OUTPUT_VALUE_RADIX UNSIGNED [get_hw_probes Inst_freq_change_syn/CNTVALUEIN -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");

                for(int datadelay=0;datadelay<32;datadelay++){
                    writeToProcess(processOutput2,2,"set_property OUTPUT_VALUE "+datadelay+" [get_hw_probes Inst_freq_change_syn/CNTVALUEIN -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                    writeToProcess(processOutput2,2,"commit_hw_vio [get_hw_probes {Inst_freq_change_syn/CNTVALUEIN} -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_freq_vio_syn\"}]]"+"\n");
                    ...
                    //开始等待触发
                    writeToProcess(processOutput2,2,"run_hw_ila [get_hw_ilas -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_ila_freq_change_syn\"}]"+"\n");                    System.out.println("process2到达检查点二#0，等待同步触发...当前datadelay："+datadelay);
                    countDownLatchs1[datadelay][0].countDown();
                    LockSupport.park();
                    System.out.println("process2通过检查点二，被合路板唤起...");

                    writeToProcess(processOutput2,2,"wait_on_hw_ila [get_hw_ilas -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_ila_freq_change_syn\"}]"+"\n");
                    writeToProcess(processOutput2,2,"upload_hw_ila_data [get_hw_ilas -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_syn/Inst_ila_freq_change_syn\"}]"+"\n");
                    writeToProcess(processOutput2,2, "write_hw_ila_data -csv_file {"+properties.getProperty("ModuleFreqSwitchSynSignalAd.samplePath")
...
//            writerAndTester3=Thread.currentThread();
            try {
                ...
                Thread.sleep(1000);
                writeToProcess(processOutput3, 3,"close_hw_target "+properties.getProperty("ModuleFreqSwitchSynSignalAd.boxNum0") + "\n");
                writeToProcess(processOutput3, 3,"close_hw_target "+properties.getProperty("ModuleFreqSwitchSynSignalAd.boxNum1") + "\n");
                writeToProcess(processOutput3, 3,"close_hw_target "+properties.getProperty("ModuleFreqSwitchSynSignalAd.boxNum2") + "\n");
                writeToProcess(processOutput3, 3,"open_hw_target "+properties.getProperty("ModuleFreqSwitchSynSignalAd.boxNum3") + "\n");
                Thread.sleep(10000);
                ...
                Thread.sleep(5000);
                writeToProcess(processOutput3, 3,"set_property PROBES.FILE "+properties.getProperty("ModuleFreqSwitchSynSignalAd.probesPath3")+" [get_hw_devices xc7vx690t_0]" + "\n");
                writeToProcess(processOutput3, 3,"set_property FULL_PROBES.FILE "+properties.getProperty("ModuleFreqSwitchSynSignalAd.probesPath3")+" [get_hw_devices xc7vx690t_0]" + "\n");
                writeToProcess(processOutput3, 3,"set_property PROGRAM.FILE "+properties.getProperty("ModuleFreqSwitchSynSignalAd.programPath3")+" [get_hw_devices xc7vx690t_0]" + "\n");
                ...
                writeToProcess(processOutput3,3, "set_property TRIGGER_COMPARE_VALUE eq1'bR [get_hw_probes Inst_rec_freq_change_syn/IO_syn -of_objects [get_hw_ilas -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_rec_freq_change_syn/Inst_ila_rec_freq_change_syn\"}]]"+"\n");
                writeToProcess(processOutput3,3, "set_property CONTROL.TRIGGER_POSITION 100 [get_hw_ilas -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_rec_freq_change_syn/Inst_ila_rec_freq_change_syn\"}]"+"\n");


                for(int datadelay=0;datadelay<32;datadelay++){
                    //第一次小循环
                    writeToProcess(processOutput3, 3,"set_property OUTPUT_VALUE 0 [get_hw_probes rec_freq_change_flag -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_flag\"}]]" + "\n");
                    writeToProcess(processOutput3, 3,"commit_hw_vio [get_hw_probes {rec_freq_change_flag} -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_flag\"}]]" + "\n");
                    ...
                    //开始等待触发
                    writeToProcess(processOutput3,3,"run_hw_ila [get_hw_ilas -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_rec_freq_change_syn/Inst_ila_rec_freq_change_syn\"}]"+"\n");
                    ...
                    writeToProcess(processOutput3, 3,"set_property OUTPUT_VALUE 1 [get_hw_probes rec_freq_change_flag -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_flag\"}]]" + "\n");
                    writeToProcess(processOutput3, 3,"commit_hw_vio [get_hw_probes {rec_freq_change_flag} -of_objects [get_hw_vios -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_freq_change_flag\"}]]" + "\n");
                    ...
                    writeToProcess(processOutput3,3,"wait_on_hw_ila [get_hw_ilas -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_rec_freq_change_syn/Inst_ila_rec_freq_change_syn\"}]"+"\n");
                    writeToProcess(processOutput3,3,"upload_hw_ila_data [get_hw_ilas -of_objects [get_hw_devices xc7vx690t_0] -filter {CELL_NAME=~\"Inst_rec_freq_change_syn/Inst_ila_rec_freq_change_syn\"}]"+"\n");
                    writeToProcess(processOutput3,3, "write_hw_ila_data -csv_file {"+properties.getProperty("ModuleFreqSwitchSynSignalAd.samplePath")
